...
<html lang="en" xmlns="http://www.w3.org/1999/html">
	...
	<head>
		...
		<meta name="author" content="Jabari O. Farrar">

		<title>Jabari O. Farrar</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li>
								<a href="https://www.linkedin.com/in/jabari-farrar/" target="_blank"><i class="fa fa-linkedin fa-lg" aria-hidden="true"></i></a>
							</li>
							<li>
		...
		<main>
			...
			<section id="experience" class="Professional Experience">
						...
						<div class="col-lg-12">
							...
							<ul>
								...
								<li>Sergey Dubin, Scott Gilje , Kan Wang, Vincent C. Tung, Kitty Cha, Anthony S. Hall,
									Jabari Farrar , Rupal Varshneya, Yang Yang , Richard B. Kaner, “A One-Step,
									Solvothermal Reduction Method for Producing Reduced Graphene Oxide Dispersion
								...
								<li>Artyushkova, K., Farrar, J.O., Fulghum, J.E., “Data Fusion of XPS and AFM Images
									for Chemical Phase Identification in Polymer Blends” Surface and InterfaceAnalysis,
									41(2), 119-126, 2009
								</li>
